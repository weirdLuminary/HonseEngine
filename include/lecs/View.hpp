...
public:
    ...
    public:
        ...
        std::tuple<Entity, Components&...> operator*() const { 
            ...
            return {
                entity,
                std::get<std::shared_ptr<ComponentArray<Components>>>(m_View->m_Storages)->Get(entity)...
            };
        }
    ...
    Iterator end() {
        return Iterator { std::get<0>(m_Storages)->Size(), this };
    }

private:

    View(Registry* reg) : m_Storages { reg->components->GetComponentArray<Components>()...} {}
